package project.spider;

import com.company.project.utils.MyStringUtils;
 ...
 */
public class CsdnBlogDetailsSpider extends BaseSpider {
	...
	public static void main(String[] args) {
		Spider.create(new CsdnBlogDetailsSpider())
				.addPipeline(null)
